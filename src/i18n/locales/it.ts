...
export const it: Translation = {
  ...
  fieldNameTooltip:
    "Usa il camelCase per una migliore leggibilità (es. firstName)",
  ...
  arrayValidationErrorMinMax:
    "'minItems' non può essere maggiore di 'maxItems'.",
  arrayValidationErrorContainsMinMax:
    "'minContains' non può essere maggiore di 'maxContains'.",
